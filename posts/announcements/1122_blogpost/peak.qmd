...
All job indices can be viewed and downloaded on the website www.swissjobtracker.ch. The data will henceforth be published every week on Friday at noon. The data basis and the calculation method of the indicator are described in detail [here](https://swissjobtracker.ch/#/about "Methodology swissjobtracker.ch").
